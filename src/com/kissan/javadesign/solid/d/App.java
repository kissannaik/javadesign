...
public class App {
    ...
    public static void main(String[] args) {
        DatabaseHandler mySQLDatabaseHandler = new DatabaseHandler(new MySQLDatabase());
        mySQLDatabaseHandler.connect();
        mySQLDatabaseHandler.disconnect();

        DatabaseHandler oracleDatabaseHandler = new DatabaseHandler(new OracleDatabase());
