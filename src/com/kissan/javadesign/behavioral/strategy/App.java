...
public class App {
    ...
    public static void main(String[] args) {
        OperationManager addOperationManager = new OperationManager(new Add());
        addOperationManager.operation(2, 5);

        OperationManager multiplyOperationManager = new OperationManager(new Multiply());
        multiplyOperationManager.operation(2, 5);
    }
}
